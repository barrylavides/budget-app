...
- Name: issue-4-ac.spec.ts >> Add source form has all required fields and creates a new source
- Location: e2e/issue-4-ac.spec.ts:88:0
...
- dialog "Add Source":
  ...
  - button "Close": ×
  - text: Name
  - textbox "e.g. Wife Payroll": Test Bonus
  - text: Type
  - combobox
  - text: Account Label
  - textbox "e.g. BDO": UnionBank
  - text: Half
  - combobox
  - text: Balance (₱)
  - spinbutton: "5000"
